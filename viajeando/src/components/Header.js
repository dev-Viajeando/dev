...
function MainHeader() {
    ...
    const handleLogout = async () => {
        // Sincroniza los favoritos con el backend si es necesario
        ...
        // Eliminar favoritos del localStorage y token de autenticación
        localStorage.removeItem('favoritos');  // Elimina los favoritos
                    ...
                    <div className="flex items-center order-2">
                        {isLoggedIn ? (
                            <Tooltip title="Cerrar sesión" arrow>
                                <IconButton onClick={handleLogout} size="large" sx={{ border: 'solid 3px' }}>
                                    <ExitToAppIcon fontSize="inherit" />
                                </IconButton>
                            </Tooltip>
                        ) : (
                            <Tooltip title="Login" arrow>
                                <IconButton href="/login" size="large" sx={{ border: 'solid 3px' }}>
